// Build What Pays — Claude main-tufte base, localized for workspace build

#set page(
  width: 8in,
  height: 10in,
  margin: (top: 0.9in, bottom: 0.95in, left: 0.9in, right: 1.35in),
  fill: rgb("#F5F2EB"),
  numbering: "1",
)

#let bwp-red = rgb("#8B1A1A")
#let bwp-ink = rgb("#1A1A1A")
#let bwp-gray = rgb("#6B6B6B")
#let bwp-grid = rgb("#D4D0C8")
#let bwp-mid = rgb("#B8B4AC")
#let display-font = ("DejaVu Sans",)
#let body-font = ("Liberation Serif", "DejaVu Serif")
#let ui-font = ("Liberation Sans", "DejaVu Sans")

#set text(font: body-font, size: 10.6pt, fill: bwp-ink)
...
#let wideblock(body) = block(above: 1em, below: 1em)[#align(center)[#body]]
...
#let chapter(title, eyebrow: none, numbering: auto) = [
  #pagebreak(weak: true)
  #if eyebrow != none [
    #text(font: ui-font, size: 8.5pt, tracking: 0.08em, weight: "bold", fill: bwp-red)[#upper(eyebrow)]
    #v(0.35em)
  ]
  #text(font: display-font, size: 20pt, tracking: 0.03em, weight: "bold", fill: bwp-ink)[#title]
  #v(0.35em)
  #line(length: 100%, stroke: 0.8pt + bwp-mid)
  #v(0.85em)
]
#let section(title) = [
  #v(0.8em)
  #text(font: ui-font, size: 10pt, tracking: 0.03em, weight: "bold", fill: bwp-ink)[#title]
  #v(0.2em)
]
#let subsection(title) = [
  #v(0.55em)
  #text(font: ui-font, size: 9.4pt, weight: "bold", fill: bwp-ink)[#title]
  #v(0.15em)
]
#let appendix-part(title) = [
  #pagebreak()
  #text(font: ui-font, size: 8.5pt, tracking: 0.08em, weight: "bold", fill: bwp-red)[APPENDICES]
  #v(0.35em)
  #text(font: display-font, size: 18pt, tracking: 0.03em, weight: "bold", fill: bwp-ink)[#title]
  #v(0.4em)
  #line(length: 100%, stroke: 0.8pt + bwp-mid)
  #v(0.9em)
]
#let appendix(title) = chapter(title, eyebrow: "Appendix")

#align(center)[
  #v(5.7em)
  #text(font: display-font, size: 29pt, tracking: 0.06em, weight: "bold", fill: bwp-ink)[BUILD WHAT PAYS]
  #v(0.35em)
  #text(font: ui-font, size: 10pt, tracking: 0.05em, weight: "bold", fill: bwp-red)[A SOLO BUILDER'S FIELD MANUAL FOR FINDING IDEAS THAT PAY]
  #v(1.4em)
  #text(font: ui-font, size: 10pt, fill: bwp-gray)[Michael Colenso]
]
...
#align(left)[
  #v(2em)
  #text(font: display-font, size: 15pt, weight: "bold", fill: bwp-ink)[Build What Pays]
  #v(0.8em)
